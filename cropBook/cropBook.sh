/usr/bin/python /Users/chrisCampbell/Dropbox/UsefulScripts/cropBook/splitter.py $@
for var in $@
do
	...
	/usr/bin/python /Users/chrisCampbell/Dropbox/UsefulScripts/cropBook/joiner.py "${name}EC.pdf" "${name}OC.pdf" 
